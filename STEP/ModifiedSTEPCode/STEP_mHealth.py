...
# ================= general ================= #
CFG.DESCRIPTION = "STEP(mHealth) configuration"
CFG.RUNNER = STEPRunner
CFG.DATASET_CLS = ForecastingDataset
CFG.DATASET_NAME = "mHealth"
CFG.DATASET_TYPE = "mHealth"
...
CFG.MODEL.PARAM = {
    ...
    "backend_args": {
                    "num_nodes" :2,
                    "supports"  : torch.tensor(np.ones((2,2))),#[torch.tensor(i) for i in adj_mx],         # the supports are not used
                    "dropout"   : 0.3,
                    "gcn_bool"  : True,
                    "addaptadj" : True,
                    "aptinit"   : None,
