...
class DiscreteGraphLearning(nn.Module):
    ...
    def __init__(self, dataset_name, k, input_seq_len, output_seq_len):
        ...
        self.num_nodes = {"motion_sense": 8, "mHealth": 2, "PEMS-BAY": 325}[dataset_name]
        self.train_length = {"motion_sense": 23990, "mHealth": 13599, "PEMS-BAY": 36482}[dataset_name]
        ...
        self.dim_fc = {"motion_sense": 15712, "mHealth": 58288, "PEMS-BAY": 583424}[dataset_name]
        ...
        ## for the dimension, see https://github.com/zezhishao/STEP/issues/1#issuecomment-1191640023
        self.dim_fc_mean = {"motion_sense": 16128, "mHealth": 16128 * 2, "PEMS-BAY": 16128}[dataset_name]
