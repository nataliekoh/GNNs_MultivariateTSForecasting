...
# ================= general ================= #
CFG.DESCRIPTION = "STEP(motion_sense) configuration"
CFG.RUNNER = STEPRunner
CFG.DATASET_CLS = ForecastingDataset
CFG.DATASET_NAME = "motion_sense"
CFG.DATASET_TYPE = "motion_sense"
CFG.DATASET_INPUT_LEN = 50
CFG.DATASET_OUTPUT_LEN = 50
CFG.DATASET_ARGS = {
    "seq_len": 50
    }
CFG.GPU_NUM = 1
...
CFG.MODEL.PARAM = {
    ...
    "backend_args": {
                    "num_nodes" : 3,
                    "supports"  : torch.tensor([[1,1],[1,1]]),#[torch.tensor(i) for i in adj_mx],         # the supports are not used
                    "dropout"   : 0.3,
                    "gcn_bool"  : True,
                    "addaptadj" : True,
                    "aptinit"   : None,
...
CFG.TRAIN.CL.PREDICTION_LENGTH = 50
