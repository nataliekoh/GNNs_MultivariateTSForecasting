...
class trainer():
    ...
    def train(self, input, real_val):
        ...
        pl_pred = predict.transpose(1,3)
        #[64, 12, 24, 1]
        p_slice = pl_pred[0, :, 0, :]
        p_slice = p_slice.transpose(0, 1)
        p_slice = p_slice.tolist()[0]          

        pl_real = real.transpose(1,3)
        pl_real = pl_real[0, :, 7, :]
        pl_real = pl_real.transpose(0, 1)
        pl_real = pl_real.tolist()[0]
        ...
        return loss.item(),mape,rmse, p_slice, pl_real
